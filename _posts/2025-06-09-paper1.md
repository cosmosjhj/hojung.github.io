...
\[
\mathcal M=\bigl\{Z_1,\ldots,Z_N;\;\mathbf R_1,\ldots,\mathbf R_N\bigr\},
\]  
...
1. **Build** \(\mathbf H^{(k)}\bigl[\rho^{(k-1)}\bigr]\) \(\mathcal O(B^{3})\) with density-fitting.  
...
|-------|------------------------|--------------|---------------------|------|
| QHNet | 65 721 kcal/mol | 3.7× | 0.78 | baseline |
...
For \(x=60\) (182 atoms) WALoss keeps HOMO/LUMO MAE < 100 kcal/mol; other models diverge.
